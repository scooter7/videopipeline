...
import numpy as np
from moviepy.editor import concatenate_videoclips, AudioFileClip, CompositeAudioClip, ImageClip, VideoFileClip
import tempfile
...
# Adapted from imagetovideo.py
def imagetovideo_function():
    ...
    if st.button('Generate Video') and uploaded_images:
        ...
        video_clip = add_audio_to_video(video_clip, speech_audio=speech_temp, background_audio=background_temp)
